...
public class NegativeSmokeTest extends BaseTest {
    ...
    @Test (groups = {"login"}, description = "Test to check system behavior using the correct password and incorrect login")
    ...
    @Test(groups = {"login"}, description = "Test to check system behavior using the correct login and incorrect password")
    ...
    @Test(groups = {"login"},description = "Test to check system behavior using no credentials")
    ...
    @Test(groups = {"search"}, description = "Test the input hint while entering nonexistent item")
    ...
    @Test(groups = {"filters"}, description = "Test system behavior while entering negative start price for the goods")
